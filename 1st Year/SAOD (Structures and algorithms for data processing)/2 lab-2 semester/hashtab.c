...
void hashtab_add(struct listnode ** hashtab, char * key, int value, int hash_type) {
...
struct listnode * hashtab_lookup(struct listnode ** hashtab, char * key, int hash_type) {
  struct listnode * node;
