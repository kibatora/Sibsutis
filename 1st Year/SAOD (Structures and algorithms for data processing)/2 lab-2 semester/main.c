...
int main() {
  ...
  case 1:
    ...
    tree = bstree_create(200001, "this");
    ...
    for (int n = 10000; n <= 200000; n += 10000) {
      ...
      for (int i = 0; i < n; i++) {
        ...
        if (i == n - 1) {
          ...
          cpu_time_usedadd1 = ((double)(endadd1 - startadd1)) / CLOCKS_PER_SEC;
          printf("Time used for bstree_add with %d words: %.12f seconds\n", n, cpu_time_usedadd1 / n);

          clock_t endadd2 = clock();
          cpu_time_usedadd2 = ((double)(endadd2 - startadd2)) / CLOCKS_PER_SEC;
          printf("Time used for hashtab_add with %d words: %.12f seconds\n \n", n, cpu_time_usedadd2 / n);
        }
      }
      ...
      double cpu_time_usedtab = ((double)(endtab - starttab)) / CLOCKS_PER_SEC;

      printf("Time used for bstree_lookup with %d words: %.12f seconds\nTime used for hashtab_lookup with %d words: %.12f seconds\n", n, cpu_time_used / 10000, n, cpu_time_usedtab / 100000);
      printf("----------------------------------------------------------------------");
      printf("\n");
  ...
  case 2:
    ...
    for (int n = 10000; n <= 200000; n += 10000) {
      ...
      double cpu_time_usedadd3 = ((double)(endadd3 - startadd3)) / CLOCKS_PER_SEC;
      ...
      printf("Time used for hashtab_lookup(KR) with %d words: %.30f seconds, collisions: %d\n \n", n, cpu_time_usedadd3 / 100000, collisions);
      collisions = 0;
    }
    fclose(fp2);
  ...
  case (3):
    ...
    for (int n = 10000; n <= 200000; n += 10000) {
      ...
      double cpu_time_usedadd4 = ((double)(endadd4 - startadd4)) / CLOCKS_PER_SEC;
      ...
      printf("Time used for hashtab_lookup(ELF) with %d words: %.30f seconds, collisions: %d\n \n", n, cpu_time_usedadd4 / 100000, collisions);
      collisions = 0;
    }
    fclose(fp4);
    exit(4);
